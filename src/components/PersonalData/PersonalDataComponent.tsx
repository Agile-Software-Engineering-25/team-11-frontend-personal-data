...
const COUNTRY_OPTIONS: Record<'de' | 'en', string[]> = {
  de: ['Deutschland', 'Österreich', 'Schweiz', 'Frankreich', 'Spanien'],
  en: ['Germany', 'Austria', 'Switzerland', 'France', 'Spain'],
};
const PersonalDataComponent = () => {
  const { t, i18n } = useTranslation();
  const countryOptions = useMemo(() => {
    const locale = i18n.language === 'de' ? 'de' : 'en';
    return COUNTRY_OPTIONS[locale];
  }, [i18n.language]);
  return (
    <>
